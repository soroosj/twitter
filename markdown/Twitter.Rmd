...
### Motivation
The goal of this blog is to analyze Twitter posts and followers for a given handle.  We will analyze the geographic distribution of followers by accessing the Google Maps API via the ggmaps package/
